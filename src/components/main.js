import { sortData, filterData, womenPhilosophersStats, philosophersBeforeXIXStats, analyticPhilosopherStats } from "../lib/dataFunctions.js";
...
const branchSelector = componentMain.querySelector('[data-testid="select-filter"]');
const orderSelector = componentMain.querySelector('[data-testid="select-sort"]');
const typeSelector = componentMain.querySelector('[data-testid="select-filter1"]');
const cleanButton = componentMain.querySelector('[data-testid="button-clear"]');
const statsButton = componentMain.querySelector('[data-testid="show-stats"]');
const statsSection = componentMain.querySelector("#stats");
const classSelector = componentMain.querySelector('[data-testid="select-filter2"]');
